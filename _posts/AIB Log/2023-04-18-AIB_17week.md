...
![image](../../assets/images/aib/section5/513_oop_1.png){: .align-center width="90%" loading="lazy"} 
...
![image](../../assets/images/aib/section5/bigo.png){: .align-center width="70%" loading="lazy"}  
...
- Linear Time(선형시간) : O(n) 
    ...
    # 전체소요시간 6.52초
    ```  
    ![image](../../assets/images/aib/section5/linear_time_on.png){: .align-center width="60%" loading="lazy"}  
...
- Quadratic Time(제곱시간) : O(n^2)  
    ...
    # 전체소요시간 128.53초
    ```  
    ![image](../../assets/images/aib/section5/quadratic_time_on2.png){: .align-center width="60%" loading="lazy"}  
...
- Log Time : O(logn)
    ...
    # 전체소요시간 134.65초
    ```
    ![image](../../assets/images/aib/section5/log_time_ologn.png){: .align-center width="60%" loading="lazy"}  
...
![image](../../assets/images/aib/section5/binarysearch.png){: .align-center width="80%" loading="lazy"} 
...
![image](../../assets/images/aib/section5/insert_sort.gif){: .align-center width="60%" loading="lazy"} 
