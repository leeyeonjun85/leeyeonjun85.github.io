...
![image](../../assets/images/etc/calculate-6780397.png){: .align-center width="50%" loading="lazy"} 
...
![image](../../assets/images/aib/section1/CLT_01.png){: .align-center width="70%" loading="lazy"}  

> 부트스트래핑으로 추출된 표본이 정규분포를 이루고 있는 모습  
![image](../../assets/images/aib/section1/CLT_02.png){: .align-center width="70%" loading="lazy"}  
