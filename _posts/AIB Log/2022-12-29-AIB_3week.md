...
![image](../../assets/images/etc/graph-3068300_1920.jpg){: .align-center width="50%" loading="lazy"} 
...
![image](../../assets/images/aib/section1/span_01.png){: .align-center width="70%" loading="lazy"}  
...
![image](../../assets/images/aib/section1/rank_01.png){: .align-center width="70%" loading="lazy"}  
...
![image](../../assets/images/aib/section1/scree_plot.png){: .align-center width="70%" loading="lazy"}  


- 두 개의 주성분으로 만든 산점도
    - X축은 첫번째 주성분, Y축은 두번째 주성분

![image](../../assets/images/aib/section1/kmeans_clustering.png){: .align-center width="70%" loading="lazy"}  
...
![image](../../assets/images/aib/section1/3k_penguin.png){: .align-center width="70%" loading="lazy"}  
...
![image](../../assets/images/aib/section1/h_cluster.png){: .align-center width="70%" loading="lazy"}  
   
- 실제자료, K-Means Clustering, Hierarchical Clustering 비교  
![image](../../assets/images/aib/section1/clusterings.png){: .align-center width="90%" loading="lazy"}  
...
![image](../../assets/images/aib/section1/e_prime.png){: .align-center width="70%" loading="lazy"}  


- $f(x) = lnx$ 의 그래프  

![image](../../assets/images/aib/section1/ln_prime.png){: .align-center width="70%" loading="lazy"} 



- $f(x) = 2x^2 + 8x$ 의 그래프  

![image](../../assets/images/aib/section1/f_prime.png){: .align-center width="70%" loading="lazy"}  


- $\sigma(x) = { {1} \over {1 + e^{-x} } }$ 의 그래프  

![image](../../assets/images/aib/section1/sig_prime.png){: .align-center width="70%" loading="lazy"} 
...
![image](../../assets/images/aib/section1/gradient_descent.gif){: .align-center width="70%" loading="lazy"} 
