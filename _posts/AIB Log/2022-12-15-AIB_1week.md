...
![image]({{ site.url }}{{ site.baseurl }}/assets\images\aib\start_road.jpg){: .align-center width="70%" loading="lazy"}  
...
![image](../../assets/images/aib/section1/bicycle_monthly_trans.png){: .align-center width="90%" loading="lazy"} 
